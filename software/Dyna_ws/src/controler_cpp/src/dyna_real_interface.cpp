...
void RealInterface::move_nn(){
    ...
    input_data.joint_angle_0 = input_joints[3]; // FR shoulder
    input_data.joint_angle_1 = input_joints[4]; // FR arm
    input_data.joint_angle_2 = input_joints[5]; // FR foot
    input_data.joint_angle_3 = input_joints[0]; // FL shoulder
    input_data.joint_angle_4 = input_joints[1]; // FL arm
    input_data.joint_angle_5 = input_joints[2]; // FL foot
    input_data.joint_angle_6 = input_joints[6]; // BL shoulder
    input_data.joint_angle_7 = input_joints[7]; // BL arm
    input_data.joint_angle_8 = input_joints[8]; // BL foot
    input_data.joint_angle_9 = input_joints[9]; // BR shoulder
    input_data.joint_angle_10 = input_joints[10]; // BR arm
    input_data.joint_angle_11 = input_joints[11]; // BR foot
